    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Liste employer</h1>
                </div>
                <div class="col-auto">
                     <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('afficher-employer') }}" type="submit" class="btn app-btn-primary">Créer</a>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="cell">{{ ($employersliste->perPage() * ($employersliste->currentPage() - 1 ))+ $loop->iteration }}</td>
