...
<div class="app-wrapper">
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Afficher Administrateur</h1>
            </div>
            <div class="col-auto">
                 <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <div class="col-auto">
                            <a href="{{ route('liste-administrateurs') }}" type="submit" class="btn app-btn-primary">Liste Administrateurs</a>
                        </div>
                    </div><!--//row-->
                </div><!--//table-utilities-->
            </div>
            ...
            <div class="col-12 col-md-10 mt-3">
                <div class="app-card app-card-settings shadow-sm p-4">
                    ...
                    <div class="app-card-body">
                        <form class="settings-form" action="{{ route('créer-departement') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nom_dep" value="{{ old('nom_dep') }}">
                                @error("nom")
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="responsable_dep" value="{{ old('responsable_dep') }}">
                                @error("responsable")
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
