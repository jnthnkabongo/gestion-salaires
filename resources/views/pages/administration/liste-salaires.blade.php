    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Liste salaire</h1>
                </div>
                <div class="col-auto">
                     <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            @if ($ispaymentday)
                                <div class="col-auto">
                                    <a href="{{ route('initialiser-paiement') }}" type="submit" class="btn app-btn-primary">Effectuer un paiement</a>
                                </div>
                            @endif
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-6 col-lg-6">
                    @if (!$ispaymentday)
                        <div class="alert alert-success"> <b>Attention :</b> Vous ne pourrez effectuer de paie qu'a la date de paiement</div>
                    @endif
                </div>
            </div>
