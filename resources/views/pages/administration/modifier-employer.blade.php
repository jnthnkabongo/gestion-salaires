                    ...
                    <div class="app-card-body">
                        <form class="settings-form" action="" method="GET">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nom_dep" value="{{  Str::upper($resultat->nom) }}">
                            </div>
                            <div class="mb-3">
                                <label for="setting-input-2" class="form-label">Prénom Employer</label>
                                <input type="text" class="form-control" name="responsable_dep" value="{{ Str::upper($resultat->prenom) }}">
                            </div>
                            <div class="mb-3">
                                <label for="setting-input-2" class="form-label">Postnom Employer</label>
                                <input type="text" class="form-control" name="responsable_dep" value="{{ Str::upper($resultat->postnom) }}">
                            </div>
                            <div class="mb-3">
                                <label for="setting-input-2" class="form-label">E-mail Employer</label>
                                <input type="text" class="form-control" name="responsable_dep" value="{{ Str::upper($resultat->email) }}">
                            </div>
                            <div class="mb-3">
                                <label for="setting-input-2" class="form-label">Sexe Employer</label>
                                <select class="form-select form-select-md md-auto " name="" id="">
                                    <option value="">{{ Str::upper($resultat->sexe) }}</option>
                                    <option value="">M</option>
                                    <option value="">F</option>
                                </select>
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Age Employer</label>
                                    <input type="text" class="form-control" name="responsable_dep" value="{{ Str::upper($resultat->age) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Contact Employer</label>
                                    <input type="text" class="form-control" name="responsable_dep" value="{{ $resultat->contact }}">
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Montant Journalier Employer</label>
                                    <input type="text" class="form-control" name="responsable_dep" value="{{ $resultat->montant_journalier }}">
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Département Employer</label>
                                    <input type="text" id="{{ $resultat->departement_id }}" class="form-control" name="responsable_dep" value="{{ $resultat->departement->nom_dep }}">
