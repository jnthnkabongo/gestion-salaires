    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">Employer Numéro {{ $FullPaymentInfo->employers->id }}</div>
            </div>
            <div class="item">
                <div class="label">Nom & prénom:</div>
                <div class="value">{{ $FullPaymentInfo->employers->nom }}
                    {{ $FullPaymentInfo->employers->prenom }} ({{ $FullPaymentInfo->employers->email }})</div>
            </div>
            <div class="item">
                <div class="label">Département:</div>
                <div class="value">{{ $FullPaymentInfo->employers->departement->nom_dep }}</div>
            </div>
            <div class="item">
                <div class="label">Mois & Année:</div>
                <div class="value">{{ $FullPaymentInfo->month }} {{ $FullPaymentInfo->years }} </div>
            </div>
            ...
            <div class="transaction_details_box">
                ...
                <div class="right">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>{{ date('d-m-Y', strtotime($FullPaymentInfo->validate_date)) }}</td>
